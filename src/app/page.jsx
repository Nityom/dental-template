          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Experienced Dentist</h3>
                  <p className="text-gray-500">Purus turpis vivamus sem est blandit in at egestas.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-teal-800 p-4 rounded-lg">
